...
public class HammingKademliaProvider implements RoutingAlgorithmProvider {
	private final static String ALGORITHM_NAME = "HammingKademlia";
	...
	public RoutingAlgorithm initializeAlgorithmInstance(
		...
		return new HammingKademlia(conf, routingSvc);
	}
}
